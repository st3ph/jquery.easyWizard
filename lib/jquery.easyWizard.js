                ...
                if(thisSettings.steps > 1) {
                    ...
                    if(thisSettings.showButtons) {
                        paginationHtml = '<div class="easyWizardButtons">';
                            paginationHtml += '<button type="button" class="prev '+thisSettings.buttonsClass+'">'+thisSettings.prevButton+'</button>';
                            paginationHtml += '<button type="button" class="next '+thisSettings.buttonsClass+'">'+thisSettings.nextButton+'</button>';
